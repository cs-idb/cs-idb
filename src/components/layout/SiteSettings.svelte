...
<div class="open-settings-wrapper">
  <span class="material-icons" class:rotate={showSettings} on:click={() => showSettings = !showSettings}>
    settings
  </span>
</div>

<div class="background-shadow" class:show={showSettings} on:click={() => showSettings = false}/>
{#if showSettings}
  <div class="settings">
    <p class="header">
      Settings
