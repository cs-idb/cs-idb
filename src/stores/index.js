...
const knife_paintkit_tags = derived(raw_knives, $raw_knives => {
  ...
  const unique_paintkit_tags = [...new Set(knife_paintkit_tags)].map(k => {
    return { value: k, label: k, knife_amount: get_knife_amount_with_paintkittag(k) };
  });
...
export {
  ...
  knife_weapon_names,
  knife_paintkit_tags,
  collections_with_knife_amount,
  get_knives_in_collection,
};
